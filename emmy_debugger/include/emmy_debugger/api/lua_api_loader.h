...
typedef lua_Hook (*dll_lua_gethook)(lua_State* L);
DEF_LUA_API(lua_gethook);
typedef int (*dll_lua_gethookmask)(lua_State* L);
DEF_LUA_API(lua_gethookmask);
typedef int (*dll_lua_gethookcount)(lua_State* L);
DEF_LUA_API(lua_gethookcount);
